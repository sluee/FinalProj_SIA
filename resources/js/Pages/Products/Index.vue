        ...
        <template #header>
            <div class="flex justify-between">
                ...
                <div class="flex">
                    ...
                    <!-- <Link v-if="$page.props.auth.user.permissions.includes('write products')" href="/products/create" class="px-3 py-2 bg-blue-300 shadow border-gray-300 border hover:bg-blue-400 rounded">Create Product</Link> -->
